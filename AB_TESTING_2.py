...
# H0 : M1 = M2 (Kontrol grubu ve test grubu satın alma ortalamalar arasında fark yoktur.)
...
#Kullanılan test bağımsız iki örneklem t-testidir çünkü normallik ve varyans
# homojenliği varsayımları sağlanmıştır.


# Adım 2: Elde ettiğiniz test sonuçlarına göre müşteriye tavsiyede bulununuz.

#Test sonuçları, Purchase ortalamaları arasında istatistiksel olarak anlamlı bir fark olmadığını
# gösterdiği için, müşteriye mevcut teklif verme yöntemlerinde bir değişiklik yapmaması önerilir.
# Yani, "average bidding" yönteminin "maximum bidding" yöntemine göre anlamlı bir avantaj sağlamadığı sonucuna varılır.